...
public class IncreaseAgeTest
{
	...
	[InlineData(PlantHealth.Thriving, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Overgrown)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Thriving)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Overgrown)]
	...
	[InlineData(PlantHealth.Stable, PlantHealth.Dying, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Thriving)]
	...
	[InlineData(PlantHealth.Stable, PlantHealth.Dying, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Overgrown)]
	...
	[InlineData(PlantHealth.Dying, PlantHealth.Dead, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Thriving)]
	...
	[InlineData(PlantHealth.Dying, PlantHealth.Dead, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Overgrown)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Dead)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Holding, SoilWaterLevel.Parched, SoilFertility.Dead)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Dead)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Dead)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Holding, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Tight, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Packed, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Dust, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Holding, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Tight, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Dust, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Holding, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Alive)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Alive)]
	...
	[InlineData(PlantHealth.Improving, PlantHealth.Thriving, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Thriving)]
	...
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Parched, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Tight, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Moist, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Moist, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Wet, SoilFertility.Dead)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Tight, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Tight, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Packed, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Tight, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Flooded, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Parched, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Tight, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Moist, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Moist, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Wet, SoilFertility.Alive)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Stable, PlantHealth.Improving, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Overgrown)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Parched, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Tight, SoilWaterLevel.Dry, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Moist, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Moist, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Wet, SoilFertility.Dead)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Tight, SoilWaterLevel.Parched, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Tight, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Packed, SoilWaterLevel.Dry, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Tight, SoilWaterLevel.Moist, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Wet, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Flooded, SoilFertility.Struggling)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Parched, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Parched, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Tight, SoilWaterLevel.Dry, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Moist, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Moist, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Wet, SoilFertility.Alive)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Parched, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Dust, SoilWaterLevel.Dry, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Holding, SoilWaterLevel.Dry, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Moist, SoilFertility.Thriving)]
	[InlineData(PlantHealth.Dying, PlantHealth.Stable, SoilRetention.Loose, SoilWaterLevel.Dry, SoilFertility.Overgrown)]
