...
public class ctorTest
{
	...
	public void ctor_GeneralCall_SetsWheatLocationToGivenLocationXAndLocationY(int expectedX, int expectedY)
	{
		...
		/// Act
		var wheat = new Wheat(map, expectedX, expectedY, PlantMaturity.Sprout, PlantHealth.Stable, 0, Mock.Create<IRandomNumberGenerator>());
	...
	public void ctor_GeneralCall_SetsCactusMaturityToGivenMaturity()
	{
		...
		/// Act
		var wheat = new Wheat(map, 0, 0, PlantMaturity.Sprout, PlantHealth.Stable, 0, Mock.Create<IRandomNumberGenerator>());
	...
	public void ctor_GeneralCall_SetsHealthToGivenPlantHealth(PlantHealth expectedHealth)
	{
		...
		/// Act
		var wheat = new Wheat(map, 0, 0, PlantMaturity.Sprout, expectedHealth, 0, Mock.Create<IRandomNumberGenerator>());
	...
	public void ctor_GeneralCall_SetsDaysInCurrentMaturityToGivenNumber(int expectedDays)
	{
		...
		/// Assert
		wheat.DaysInCurrentMaturity.ShouldBe(expectedDays);
	}
}
